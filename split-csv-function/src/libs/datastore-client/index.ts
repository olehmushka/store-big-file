...
export class DatastoreClient implements IDatastoreClient {
  ...
  public async saveLargeBulk<T>(records: T[]): Promise<Either<Error | unknown, void>> {
  ...
  public async updateLargeBulk<T>(records: T[]): Promise<Either<Error | unknown, void>> {
    for (const items of chunk(records, 500)) {
  ...
  public async upsertLargeBulk<T>(records: T[]): Promise<Either<Error | unknown, void>> {
    for (const items of chunk(records, 500)) {
